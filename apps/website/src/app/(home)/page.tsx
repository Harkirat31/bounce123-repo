    ...
    return (    
        <div className="space-y-8 sm:space-y-12 px-2 sm:px-4 lg:px-8">
                ...
                <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center relative z-10">
                    ...
                    <div className="space-y-6 sm:space-y-8">
                        ...
                        <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
                            <a 
                                ...
                                className="inline-flex items-center justify-center px-6 sm:px-8 py-3 sm:py-4 bg-primary-600 text-white font-semibold rounded-xl hover:shadow-button-hover hover:scale-105 transition-all duration-200 shadow-button text-sm sm:text-base"
                            >
                                Get Started
                    ...
                    <div className="relative">
                        <div className="relative w-full max-w-4xl mx-auto">
                            <div className="absolute inset-0 bg-primary-400 rounded-3xl blur-3xl opacity-20 animate-pulse"></div>
                ...
                <div className="bg-white rounded-3xl shadow-section p-6 sm:p-8 lg:p-12 border border-slate-100">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 items-center">
                        ...
                        <div className="flex items-start space-x-3 sm:space-x-4 group">
                            <div className="w-12 h-12 sm:w-16 sm:h-16 bg-primary-100 rounded-xl flex items-center justify-center text-primary-600 flex-shrink-0 shadow-card group-hover:shadow-card-hover transition-all duration-300">
                        ...
                        <div className="flex items-start space-x-3 sm:space-x-4 group">
                            ...
                            <div className="bg-slate-50 p-4 sm:p-6 rounded-2xl shadow-card flex-1">
                                ...
                                <a 
                                    ...
                                    className="inline-flex items-center px-4 sm:px-6 py-2 sm:py-3 bg-primary-600 text-white font-semibold rounded-lg hover:shadow-button-hover hover:scale-105 transition-all duration-200 shadow-button text-sm sm:text-base"
                                >
            ...
            <section className="py-8 sm:py-10 text-center">
                <div className="bg-primary-600 rounded-3xl p-6 sm:p-8 lg:p-12 text-white relative overflow-hidden shadow-section">
                    {/* Background Pattern */}
